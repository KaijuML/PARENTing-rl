...
class ArgumentParser(cfargparse.ArgumentParser):
    ...
    def validate_model_opts(cls, model_opt):
        ...
        if 'sarnn' in [model_opt.encoder_type, model_opt.decoder_type]:
            assert model_opt.encoder_type == model_opt.decoder_type, \
                "StructureAware should be selected for both encoder/decoder"
